      ...
      <div class="wrapper">
        <div class="sidebar">
          <ul class="navbar-nav">
            ...
            <li>
              <a href="prestamo.html" class="nav-link"><i class="fa-solid fa-hand-holding-dollar"></i> Pr�stamos</a>
            </li>
            <li>
              <a href="index.html" class="nav-link"><i class="fa-solid fa-right-from-bracket"></i> Cerrar Sesi�n</a>
            </li>
          </ul>
        </div>
      </div>
